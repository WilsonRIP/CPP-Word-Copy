...
static constexpr auto qt_meta_stringdata_ZN9FormatBarE = QtMocHelpers::stringData(
    "FormatBar"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9FormatBarE[] = {
...
Q_CONSTINIT const QMetaObject FormatBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9FormatBarE.offsetsAndSizes,
    qt_meta_data_ZN9FormatBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9FormatBarE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FormatBar, std::true_type>
    >,
    nullptr
} };
...
void *FormatBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9FormatBarE.stringdata0))
